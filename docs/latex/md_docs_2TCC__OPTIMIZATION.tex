...
\end{DoxyItemize}\hypertarget{md_docs_2TCC__OPTIMIZATION_autotoc_md18}{}\doxysection{\texorpdfstring{Hardcore C Tricks}{Hardcore C Tricks}}\label{md_docs_2TCC__OPTIMIZATION_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{md_docs_2TCC__OPTIMIZATION_autotoc_md19}{}\doxysection{\texorpdfstring{Portable Assembly Strategy}{Portable Assembly Strategy}}\label{md_docs_2TCC__OPTIMIZATION_autotoc_md19}
Inline assembly is kept ISA-\/neutral by guarding each block with architecture checks and providing a pure-\/C fallback. Most math code now relies on the limb helpers instead, keeping the exported APIs ISA-\/neutral even on Tiny\+CC builds.\hypertarget{md_docs_2TCC__OPTIMIZATION_autotoc_md20}{}\doxysection{\texorpdfstring{Tiny\+CC Streaming Fast Paths}{Tiny\+CC Streaming Fast Paths}}\label{md_docs_2TCC__OPTIMIZATION_autotoc_md20}
To keep allocator-\/heavy codepaths fast under Tiny\+CC, the library now exposes {\ttfamily ttak\+\_\+mem\+\_\+stream\+\_\+zero} / {\ttfamily ttak\+\_\+mem\+\_\+stream\+\_\+copy}. These helpers are implemented with hand-\/written assembly for amd64 (REP MOV/\+STOS), arm64 (paired {\ttfamily ldp/stp}), riscv64 ({\ttfamily ld}/{\ttfamily sd} pairs), mips64el ({\ttfamily ld}/{\ttfamily sd} loops), and ppc64le ({\ttfamily mtctr} + {\ttfamily ld}/{\ttfamily std} bursts). When libttak is compiled with Tiny\+CC on any of those ISAs, every arena/pocket/\+VMA zero or duplication funnels through the tuned paths, sidestepping Tiny\+CC’s -\/O0 codegen limits. If the target ISA is not covered, the helpers fall back to cache-\/friendly C loops so behavior stays portable.\hypertarget{md_docs_2TCC__OPTIMIZATION_autotoc_md21}{}\doxysection{\texorpdfstring{Applying the Tricks Elsewhere}{Applying the Tricks Elsewhere}}\label{md_docs_2TCC__OPTIMIZATION_autotoc_md21}
