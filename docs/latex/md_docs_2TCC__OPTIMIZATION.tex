...
Inline assembly is kept ISA-\/neutral by guarding each block with architecture checks and providing a pure-\/C fallback. Most math code now relies on the limb helpers instead, keeping the exported APIs ISA-\/neutral even on Tiny\+CC builds.\hypertarget{md_docs_2TCC__OPTIMIZATION_autotoc_md20}{}\doxysection{\texorpdfstring{Applying the Tricks Elsewhere}{Applying the Tricks Elsewhere}}\label{md_docs_2TCC__OPTIMIZATION_autotoc_md20}
