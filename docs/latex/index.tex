...
\Hypertarget{index_md_bench_2ttl-cache-multithread-bench_2README}%
 A high-\/performance benchmark for {\ttfamily libttak} simulating a TTL-\/based cache with generational memory management.\hypertarget{index_autotoc_md1}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{index_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysection{\texorpdfstring{Build}{Build}}\label{index_autotoc_md2}

\begin{DoxyCode}{0}
\DoxyCodeLine{make}

\end{DoxyCode}
\hypertarget{index_autotoc_md3}{}\doxysection{\texorpdfstring{Run}{Run}}\label{index_autotoc_md3}

\begin{DoxyCode}{0}
\DoxyCodeLine{./ttl\_cache\_bench\ [options]}

\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{index_autotoc_md4}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md5}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{index_autotoc_md5}

\begin{DoxyCode}{0}
\DoxyCodeLine{./ttl\_cache\_bench\ -\/-\/threads\ 8\ -\/-\/duration\ 20\ -\/-\/value-\/size\ 1024\ -\/-\/shards\ 32}

\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{Metrics}{Metrics}}\label{index_autotoc_md6}
