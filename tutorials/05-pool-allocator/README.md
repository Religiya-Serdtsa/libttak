...
3. Mirror `ttak_object_pool_create/alloc/free/destroy` inside `src/container/pool.c`, then run `make tests/test_pool` to execute the pool regression in `tests/test_pool.c`.
