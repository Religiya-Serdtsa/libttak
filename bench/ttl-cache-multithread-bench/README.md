...
For the compiler-comparison section, each compiler is now measured for **60 seconds** (instead of a short 3-second sample) so the trend reflects steady-state behavior better:
